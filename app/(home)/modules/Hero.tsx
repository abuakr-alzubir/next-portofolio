        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_24rem] gap-12 md:gap-4 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-netural-700 mb-8">
              ...
              <b>1+ years of experience</b>. I enjoy crafting solutions that are{" "}
              <b>meaningful</b> and at the same <b>challenging</b>.
              <br />
            ...
            <div className="flex items-center gap-x-4">
              <SocialMediaLinks
                src="linkedin"
                href="https://www.linkedin.com/in/bakryelzzubair"
              />
            </div>
          </div>
